...
5. Si el usuario se siente abrumado, no sabe por dónde empezar o tiene demasiadas tareas pendientes, es OBLIGATORIO usar 'random_task_picker' para elegir una tarea por ély romper la parálisis por decisión.
